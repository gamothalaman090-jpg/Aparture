                ...
                <div className="flex space-x-3 overflow-x-auto pb-2">
                  {galleryImages.map((img, idx) => (
                    <button
                      ...
                      className={`w-20 h-16 rounded-xl overflow-hidden border-2 transition-all shrink-0 ${activeImageIndex === idx ? 'border-cyan-400 scale-105 shadow-cyan-glow' : 'border-white/10 opacity-60 hover:opacity-100'
                        }`}
                    >
          ...
          <div className="lg:col-span-5 glass-panel-cinema rounded-3xl p-6 sm:p-8 border border-white/10 space-y-6 sticky top-28">
            ...
            <div className="border-b border-white/10 pb-4">
              ...
              <div className="flex items-baseline justify-between">
                ...
                <span className={`text-xs font-mono px-2.5 py-1 rounded-full border ${isAvailable ? 'text-emerald-400 bg-emerald-500/10 border-emerald-500/20' : 'text-rose-400 bg-rose-500/10 border-rose-500/20'
                  }`}>
