      ...
      <div className="glass-panel-cinema rounded-3xl p-6 sm:p-8 max-w-lg w-full border border-white/15 shadow-2xl relative space-y-6 font-mono text-xs">
        ...
        <div className="border-b border-white/10 pb-4">
          ...
          <p className="text-slate-400 text-[11px] mt-1">
            Customer: <span className="text-white font-bold">{booking?.userId?.name || booking?.user?.name || 'Customer'}</span> &bull; {booking?.cameraId?.name || booking?.camera?.name || 'Gear Item'}
          </p>
        </div>
